...
![image](https://github.com/user-attachments/assets/04fdf0a9-a161-42aa-9a62-9c36acdab3c5)

## 백준 허브 폴더 옮기기

```
chmod +x move_folders.sh
./move_folders.sh
```
...
3. 생성된 폴더에 자신의 소스코드를 업로드 한다. (폴더명이나 파일명에 콜론":" 안됩니다!)
...
- commit 메세지: [문제 출처(플랫폼)] 문제이름 / 난이도 / 걸린시간 / 사용한 프로그래밍언어
- description: 문제 주소 (option)
- 터미널에서 작성법:

```
git commit -m "[BOJ] Hello World / 브론즈5 / 1분 / python" -m "https://www.acmicpc.net/problem/2557"
```
